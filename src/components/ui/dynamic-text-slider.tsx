...
export default function TitleComponent() {
  ...
  return (
    <div className="w-full py-20 bg-white dark:bg-black text-white flex flex-col items-center justify-center text-center px-4 font-sans">
 ...
 */
function OpenSourceSlider({ width: initialWidth, height = 70, handleSize = 28, onChange }: { width: number, height?: number, handleSize?: number, onChange?: (val: any) => void }) {
