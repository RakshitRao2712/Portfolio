  ...
  return (
    <div className="relative flex h-dvh w-full items-center justify-center bg-black overflow-hidden">
      <div className="relative">
        ...
        <motion.div
          className="relative flex h-[30rem] w-96"
        ...
        >
          <img
            ...
            width={1000}
            height={1000}
            className="absolute inset-y-0 left-0 h-full w-40 object-contain"
          />
          ...
          {HERO_CARDS.map((card, index) => {
            ...
            return (
              <motion.div
                key={card.activeSrc}
                className={`group absolute -bottom-2 ${card.left} z-20 h-full w-40 cursor-pointer ${card.className ?? ""}`}
